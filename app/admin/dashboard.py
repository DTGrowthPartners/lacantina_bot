...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .brand-logo { width: 32px; height: 32px; border-radius: 8px; background: var(--chip-orange-bg); color: var(--chip-orange); display: grid; place-items: center; font-weight: 700; font-size: 14px; overflow: hidden; }
